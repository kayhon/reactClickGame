...
class App extends Component {
  ...
  clickedFighter = id => {
    ...
    // after first click!
    let clickMessage =
      "..Nice! Keep on Clicking different Fighters to earn points, but dont click 1 TWICE!";
    ...
    if (clickedFighters.indexOf(id) === -1) {
      ...
      alert(
        "You Win Player!!, you clicked each fighter without clicking it twice! You are the Official 'Injustice 2 Click Game' CHAMPION!! Congrats..."
      );
      ...
      //  winning msg:
      clickMessage =
        "You Won Player! Your the Injustice2 Click Champion! Play Again?";
      /* // 7-15-added: */
      // rightWrong: "You win!"
      ...
      // loosing message
      clickMessage =
        "Ok so you lost that last game, LETS GO!! ?! ((Start Over))";
